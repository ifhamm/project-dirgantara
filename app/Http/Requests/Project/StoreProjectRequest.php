...
class StoreProjectRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'aircraft_series'  => ['nullable', 'string', 'max:100'],
            ...
            'phases.predock.allocation_percentage' => ['nullable', 'numeric', 'min:0', 'max:100'],
            ...
            'phases.indock.allocation_percentage' => ['nullable', 'numeric', 'min:0', 'max:100'],
            ...
            'phases.postdock.allocation_percentage' => ['nullable', 'numeric', 'min:0', 'max:100'],
        ];
    }
