...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('mws_parts', function (Blueprint $table) {
            ...
            $table->string('PART NUMBER', 100);
            $table->string('SERIAL NUMBER', 100);
            ...
            $table->string('IWO NO', 100)->unique();
            ...
            $table->boolean('IS URGENT')->nullable();
            $table->boolean('URGENT REQUEST')->nullable();
            $table->integer('CURRENT STEP')->nullable();
