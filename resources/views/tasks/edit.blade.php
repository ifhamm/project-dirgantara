...
<div class="container-lg py-5">
    ...
    <div class="mb-4">
        <div class="d-flex align-items-center gap-2 small text-muted mb-1">
            ...
            <span>/</span>
            <span class="text-dark">Edit Task</span>
        </div>
    ...
    <form action="{{ route('tasks.update', [$taskGroup, $task]) }}" method="POST">
        @csrf
        @method('PUT')
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="date" id="finish_date" name="finish_date"
                            value="{{ old('finish_date', $task->finish_date?->format('Y-m-d')) }}"
                            class="form-control form-control-lg" />
                    </div>
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="number" id="work_days" name="work_days"
                            value="{{ old('work_days', $task->work_days) }}"
                            placeholder="0" min="1"
                            class="form-control form-control-lg" />
                    </div>
